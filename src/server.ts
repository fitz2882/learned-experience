...
export const SERVER_NAME = "experience";
export const SERVER_VERSION = "0.1.0";

export const PROTOCOL = `experience-mcp: a persistent catalogue of problems this user's agents have solved before. It is shared across every model and tool the user works with. Use it so nothing has to be learned twice.
